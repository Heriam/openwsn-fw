...
*/
#define SLOTFRAME_LENGTH    20 //should be 101
...
#define SCHEDULE_MAXHARDCODED_CELLS								  16
...
*/
#define MAXACTIVESLOTS       (SCHEDULE_MINIMAL_6TISCH_ACTIVE_CELLS+NUMSERIALRX+NUMSLOTSOFF+SCHEDULE_MAXHARDCODED_CELLS)
