...
owerror_t bier_send(OpenQueueEntry_t *msg) {
	...
	if(msg->l2_nextORpreviousHop.addr_64b[7]==0x4a){
		...
		msg->l2_trackID = 5;
	}else if(msg->l2_nextORpreviousHop.addr_64b[7]==0x06){
		msg->l2_trackID = 6;
	}
...
void bier_notifEndOfSlotFrame() {
	...
	// delete any pending track 3 packet for the experiment
	openqueue_removeAllOnTrack(3);
